public function testExtraComma() {
  $prefix = 'test7472525';
  ...
  $create_base = "CREATE TABLE base_table (id int NOT NULL PRIMARY KEY, langcode varchar(12), revision_id int, [path] nvarchar(255), [alias] nvarchar(255))";
  $create_path = "CREATE TABLE path_alias (id int NOT NULL PRIMARY KEY, langcode varchar(12), revision_id int, [path] nvarchar(255), [alias] nvarchar(255))";
